    ...
    <div className="bg-ink">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-ink/85 backdrop-blur-lg">
        <div className="container-x flex items-center justify-between px-5 py-3 lg:px-12">
          <a href={LINKS.site} aria-label="Ir para o site da campanha" className="inline-flex rounded-xl bg-white px-3 py-2 shadow-card">
            <Logo className="h-10" />
          </a>
          <div className="flex items-center gap-3">
            <a href={LINKS.site} className="hidden text-sm font-semibold text-white/70 hover:text-white sm:block">
              ← Campanha
            </a>
            <a
              href="#assinar"
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-ink-radial px-5 py-24 text-center sm:py-28 lg:px-12">
          <div className="container-x relative">
            ...
            <Reveal delay={0.15}>
              <a href={LINKS.site} className="mt-10 inline-block text-sm font-semibold text-white/50 hover:text-gold">
                ← Conheça a campanha do Edinho 2525
              </a>
            </Reveal>
          </div>
        </section>
