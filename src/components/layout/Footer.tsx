    ...
    <footer className="border-t border-white/10 bg-ink">
      <div className="container-x px-5 py-16 lg:px-12">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[0.24em] text-gold-400">Campanha</h4>
            <ul className="mt-5 space-y-3 text-sm text-white/60">
              <li><a href={LINKS.site} className="hover:text-gold">Início</a></li>
              <li><a href={`${LINKS.site}/#resultados`} className="hover:text-gold">Resultados</a></li>
              <li><a href={`${LINKS.site}/#compromissos`} className="hover:text-gold">Compromissos</a></li>
              <li><a href={`${LINKS.site}/#faca-parte`} className="hover:text-gold">Faça parte</a></li>
              <li><a href="#assinar" className="hover:text-gold">Assinar o abaixo-assinado</a></li>
            </ul>
          </div>
